...
SELECT
 ...
 GROUP
 	BY
 	   DEPT_CODE;
-- 주의할 점 : GROUP BY절 사용 시 GROUP으로 나누지 않는 컬럼은 SELECT 할 수 없음
...
/*
 * < 실행 순서 >
 * 5 : SELECT 조회하고자하는 컬럼명 / 함수식 / 산술연산자 / 리터럴값 / * AS "별칭"
 * 1 :  FROM 조회하고자하는 테이블명
 * 2 : WHERE 조건식
...
-- EMPLOYEE 테이블로부터 각 직급별(JOB_CODE)별 총 급여합이 1000만원 이상인 직급의
